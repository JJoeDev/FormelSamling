...
inline void ApplyStyles(){
	...
	style.Colors[ImGuiCol_CheckMark] = ImVec4(0.4980392156862745f, 0.7058823529411765f, 1.0f, 1.0f);
	style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.4980392156862745f, 0.7058823529411765f, 1.0f, 1.0f);
	style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.24313725490196078f, 0.3686274509803922f, 0.611764705882353f, 1.0f);
	...
	style.Colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.4980392156862745f, 0.7058823529411765f, 1.0f, 1.0f);
